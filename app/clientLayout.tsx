...
export default function ClientLayout({
  ...
  return (
    <html lang="en">
      <body className={`font-sans ${batangas.variable} antialiased`}>
          ...
          <div className="hover-lift p-4 rounded-lg bg-card/50 backdrop-blur-sm border border-border/50">
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2 text-muted-foreground">
                ...
                <span>primusvlog@gmail.com</span>
              </div>
              <div className="flex items-center gap-2 text-muted-foreground">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
                </svg>
                <span>99932XXXXX</span>
              </div>
            </div>
          </div>

          {/* Follow Us Bar with Glassmorphism */}
          <div className="glass-effect hover-lift p-4 rounded-lg">
            <h3 className="font-semibold text-lg mb-3 text-primary">Follow Us</h3>
